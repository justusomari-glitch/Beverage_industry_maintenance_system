...
PRODUCTION_LINE_MACHINES=MACHINES_DF[
    MACHINES_DF['section'] == "Production Line"
].to_dict("records")
...
def run():
    ...
    print(f"Production Line Producer Started - {len(PRODUCTION_LINE_MACHINES)} machines sending data to topic '{topic}'")
